...
namespace J2.API.Migrations
{
    ...
    [Migration("20240627050700_AddMessage")]
            ...
            modelBuilder.Entity("J2.API.Models.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 6, 27, 8, 36, 59, 717, DateTimeKind.Local).AddTicks(101),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 27, 8, 36, 59, 717, DateTimeKind.Local).AddTicks(109),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 27, 8, 36, 59, 717, DateTimeKind.Local).AddTicks(110),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 27, 8, 36, 59, 717, DateTimeKind.Local).AddTicks(111),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 27, 8, 36, 59, 717, DateTimeKind.Local).AddTicks(113),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 27, 8, 36, 59, 717, DateTimeKind.Local).AddTicks(114),
            ...
            modelBuilder.Entity("J2.API.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "085f4ac0-3f03-4c49-9202-fe8483a6500d",
                            Email = "s.m.jebelli@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "S.M.JEBELLI@GMAIL.COM",
                            NormalizedUserName = "S.M.JEBELLI@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEKNKL7wug8AeQ+J+riahpIltQIKDq46Oc7p6pp69N9cHo8HV3yGVAqbFijI3GQzDlQ==",
                            PhoneNumber = "09355270270",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "dcabeaa5-8640-4d9b-abeb-b5c9847d0a5b",
