...
namespace J2.API.Migrations
{
    ...
    [Migration("20240621080020_seedCategories")]
            ...
            modelBuilder.Entity("J2.API.Models.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 6, 21, 11, 30, 19, 335, DateTimeKind.Local).AddTicks(721),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 21, 11, 30, 19, 335, DateTimeKind.Local).AddTicks(745),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 21, 11, 30, 19, 335, DateTimeKind.Local).AddTicks(746),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 21, 11, 30, 19, 335, DateTimeKind.Local).AddTicks(747),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 21, 11, 30, 19, 335, DateTimeKind.Local).AddTicks(748),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTime(2024, 6, 21, 11, 30, 19, 335, DateTimeKind.Local).AddTicks(749),
            ...
            modelBuilder.Entity("J2.API.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f87d68d0-3f5a-4305-882c-4eaa23eeabb4",
                            Email = "s.m.jebelli@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "S.M.JEBELLI@GMAIL.COM",
                            NormalizedUserName = "S.M.JEBELLI@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEC2AMviU6HkJcTjf6OeH7e1S68VL+bCo7+jAuHCX24WhZiLcLzV3HQ7A8U6JT85vSA==",
                            PhoneNumber = "09355270270",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4a4b26ee-21da-4ca3-a1d9-24553b2d685d",
